...
- Removed active runtime coupling to legacy name-mangled tool-builder helpers.
- Added provider-neutral function and retriever tool factories.
- Routed canonical agent construction through the shared tool factory boundary.
- Added dependency-isolated regression coverage for tool construction.
